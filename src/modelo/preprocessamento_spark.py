...
class PreProcessadorDadosSpark:
    ...
    '''def processar_dados_treino(
        ...
        try:
            ...
            # Processar timestamps no histórico com tratamento de datas antigas
            ...
            timestamp_expressions = [
                validar_timestamp(element_at(col("timestampHistory"), i + 1))
            ...
            df_treino_final = df_treino_final \
                ...
                .withColumn(
                    "timestampHistory",
                    array_remove(col("timestampHistory_filtered"), None)
                ) \
            ...
            # Salvar dados processados com configurações otimizadas
            try:
